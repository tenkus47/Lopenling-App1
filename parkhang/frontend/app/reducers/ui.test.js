...
test('addedTemporaryAnnotation', () => {
    ...
    const annotation = new TemporaryAnnotation(null, baseWitness, 0, 27, "༄༅༅", ANNOTATION_TYPES.variant, baseWitness, user);
...
test('removedTemporaryAnnotation', () => {
    ...
    const annotation = new TemporaryAnnotation(null, baseWitness, 0, 27, "༄༅༅", ANNOTATION_TYPES.variant, baseWitness, user);
    const extraAnnotation = new TemporaryAnnotation(null, baseWitness, 28, 1, "ཀ", ANNOTATION_TYPES.variant, baseWitness, user);
