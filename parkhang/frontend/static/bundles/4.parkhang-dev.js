...
var SplitTextComponent = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(SplitTextComponent, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var _Alignment$target, _this$props, _this$props2;
      ...
      var condition = (Alignment === null || Alignment === void 0 ? void 0 : (_Alignment$target = Alignment.target) === null || _Alignment$target === void 0 ? void 0 : _Alignment$target.witness) === this.props.selectedWitness.id;
      ...
      if (this.selectedWindow === 1 && scrollToId.from === 1 && this.isPanelLinked && condition && scrollToId.id !== null) {
        var _list = this.list;
      ...
      if (targetId2 && scrollToId.from === null && this.selectedWindow === 1) {
